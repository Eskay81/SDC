      ...
      if (s != "") {
        ...
        if (event == "telemetry") {
          ...
          if (!pf.initialized()) {
			...
			std::cout << "sense_x : " << sense_x ;
			std::cout << "\t sense_y : " << sense_y ;
			std::cout << "\t sense_theta : " << sense_theta ;
			std::cout << "\n";
		  ...
		  // sense_observations in JSON format [{obs_x,obs_y},{obs_x,obs_y},...{obs_x,obs_y}]
		  	...
		  	std::cout << " sense_observations_x : " << sense_observations_x << "\n";
		  	std::cout << " sense_observations_y : " << sense_observations_y << "\n";
        	...
        	std::cout << " Size of Noisy Observation is : " << noisy_observations.size() << "\n";
